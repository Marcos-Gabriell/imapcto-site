    ...
    <section className="bg-preto-profundo text-branco-neutro py-16 md:py-24 lg:py-36 relative overflow-hidden">
      ...
      <h2 className="text-4xl md:text-5xl font-extrabold mb-10 text-azul-principal text-left w-full">
        ...
        <div className="flex flex-col items-center mb-10 text-center px-4">
          ...
          <h3 className="text-fuchsia-600 text-2xl md:text-3xl font-bold mb-2">
            IMPACTO
          ...
          <p className="text-xl md:text-4xl font-extrabold text-white mb-6 max-w-3xl leading-snug">
          ...
          <div className="text-center text-gray-300 text-sm md:text-base max-w-2xl leading-relaxed space-y-3">
            <p>
        ...
        <div className="flex flex-col items-center gap-10 mt-16 md:hidden">
          {/* Fundação */}
          <div className="flex flex-col items-center text-center">
            <div className="w-20 h-20 rounded-full bg-gradient-to-br from-fuchsia-600 to-pink-500 flex items-center justify-center shadow-md">
              <Rocket size={32} className="text-white" />
            </div>
            <p className="mt-2 text-base text-white font-semibold">2024</p>
            <p className="text-sm text-white/80 font-medium">Fundação</p>
          ...
          {/* Expansão */}
          <div className="flex flex-col items-center text-center">
            <div className="w-20 h-20 rounded-full bg-gradient-to-br from-purple-600 to-violet-500 flex items-center justify-center shadow-md">
              <TrendingUp size={32} className="text-white" />
            </div>
            <p className="mt-2 text-base text-white font-semibold">2025</p>
            <p className="text-sm text-white/80 font-medium">Expansão</p>
          ...
          {/* Futuro */}
          <div className="flex flex-col items-center text-center">
            <div className="w-20 h-20 rounded-full bg-gradient-to-br from-cyan-500 to-blue-500 flex items-center justify-center shadow-md">
              <Lightbulb size={32} className="text-white" />
            </div>
            <p className="mt-2 text-base text-white font-semibold">Futuro</p>
            <p className="text-sm text-white/80 font-medium">Inovação</p>
